// To parse this data:
//
//   import { Convert, GifsSearch } from "./file";
//
//   const gifsSearch = Convert.toGifsSearch(json);
//
...
export class Convert {
    public static toGifsSearch(json: string): GifsSearch {
        return cast(JSON.parse(json), r("GifsSearch"));
    }

    public static gifsSearchToJson(value: GifsSearch): string {
        return JSON.stringify(uncast(value, r("GifsSearch")), null, 2);
    }
}
